(function($) {
	...
	function range_slider() {
		if ($('#slider-range').length) {
			...
			$('#amount').val(
				'$' + $('#slider-range').slider('values', 0) + 'K - $' + 'M' + $('#slider-range').slider('values', 1)
			);
		}
	}
	range_slider();
	...
	function range_slider2() {
		if ($('#slider-range2').length) {
			...
			$('#amount2').val(
				'' + $('#slider-range2').slider('values', 0) + 'm - ' + 'm' + $('#slider-range2').slider('values', 1)
			);
		}
	}
	range_slider2();
	...
	function price_widget() {
		if ($('#price_wd').length) {
			...
			$('#amount').val(
				'CHF ' + $('#price_wd').slider('values', 0) + ' - CHF ' + $('#price_wd').slider('values', 1)
			);
		}
	}
	price_widget();
